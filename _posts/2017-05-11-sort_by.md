...
Test. My goal was to get clearer about how `sort_by` works internally. Or rather, how it must work, because I have no direct way to check. My initial hunch was that `sort_by` seems fairly closely related to the `map` method.
